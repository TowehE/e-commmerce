    ...
    try {
        const validateSchema = joi.object({
            ...
            firstName: joi.string().min(3).max(30).trim().required().messages({
                'string.empty': "firstName field can't be left empty",
                'string.min': "Minimum of 3 characters for the firstName field",
                'any.required': "Please firstName is required"
            }),
             
            lastName: joi.string().min(3).max(30).trim().required().messages({
                'string.empty': "lastName field can't be left empty",
                'string.min': "Minimum of 3 characters for the lastName field",
                'any.required': "Please lastName is required"
            }),
